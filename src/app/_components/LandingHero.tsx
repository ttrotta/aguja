...
import { ToolPanelPreview } from "./ToolPanelPreview";
...
function BigNeedle() {
  return (
    <svg
      ...
      fill="none"
      aria-hidden="true"
      className="needle-sway thread-glow relative z-10 h-auto w-full max-w-[220px] md:-mr-20"
    >
      <path
...
export function LandingHero() {
  ...
  return (
    <section className="relative mx-auto flex w-full max-w-7xl flex-col items-center gap-14 overflow-x-clip px-6 py-20 md:min-h-[calc(100vh-69px)] md:flex-row md:items-center md:justify-between md:gap-4 md:py-0">
      <div className="flex flex-col items-center gap-10 md:flex-row md:items-center md:gap-2">
        <div className="flex flex-col items-center gap-8 text-center md:items-start md:text-left">
          <h1 className="font-display text-[clamp(3.5rem,10vw,7.5rem)] leading-[0.92] font-black tracking-tight text-text">
            {t("heroTitle")}
          </h1>
          <p
